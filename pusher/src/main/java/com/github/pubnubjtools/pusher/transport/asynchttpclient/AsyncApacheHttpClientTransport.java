package com.github.pubnubjtools.pusher.transport.asynchttpclient;
...
public class AsyncApacheHttpClientTransport implements AsyncTransport {
    ...
    @Override
    public CompletableFuture<Response> executeHttpGetRequest(Request request) throws IOException {
